...
@section('content')
    ...
    <div class="quick-actions">
        ...
        <div class="action-buttons">
            ...
            <a href="{{ route('admin.portfolios.create') }}" class="action-btn">
                <div class="action-btn-icon">
                    <i class="fas fa-briefcase"></i>
                </div>
                <div>
                    <div class="font-semibold">Add Portfolio</div>
                    <div class="text-sm opacity-75">Add to your portfolio</div>
                </div>
            </a>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="recent-section">
            <div class="section-header">
                <h3 class="section-title">Recent Portfolios</h3>
                <a href="{{ route('admin.portfolios.create') }}" class="section-action">
                    <i class="fas fa-plus mr-2"></i>Add New
                </a>
            </div>
            <div class="space-y-4">
                @forelse($recentPortfolios as $portfolio)
                    <div class="recent-item">
                        <h4 class="recent-item-title">{{ $portfolio->title }}</h4>
                        <p class="recent-item-description">{{ Str::limit($portfolio->description, 80) }}</p>
                        <div class="recent-item-meta">
                            <span class="recent-item-time">
                                <i class="fas fa-clock mr-1"></i>{{ $portfolio->created_at->diffForHumans() }}
                            </span>
                            <div class="recent-item-actions">
                                <a href="{{ route('admin.portfolios.edit', $portfolio) }}" class="recent-item-action edit">
                                    Edit
                                </a>
                            </div>
                        </div>
                ...
                @empty
                    <div class="empty-state">
                        ...
                        <p class="empty-state-text">No portfolios yet</p>
                        <a href="{{ route('admin.portfolios.create') }}" class="section-action">
